...
class ImageInfoData {
  static const List<ImageInfo> values = [
    ImageInfo('The Flow', 'Sponsored | Season 1 Now Streaming', 'content_based_color_scheme_1.png'),
    ImageInfo(
      'Through the Pane',
      'Sponsored | Season 1 Now Streaming',
      'content_based_color_scheme_2.png',
    ),
    ImageInfo('Iridescence', 'Sponsored | Season 1 Now Streaming', 'content_based_color_scheme_3.png'),
    ImageInfo('Sea Change', 'Sponsored | Season 1 Now Streaming', 'content_based_color_scheme_4.png'),
    ImageInfo('Blue Symphony', 'Sponsored | Season 1 Now Streaming', 'content_based_color_scheme_5.png'),
    ImageInfo('When It Rains', 'Sponsored | Season 1 Now Streaming', 'content_based_color_scheme_6.png'),
  ];
}
